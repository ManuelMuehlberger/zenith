...
class ArchiveTriggerFooterState extends State<ArchiveTriggerFooter> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color trackColor = Color(0xFFE5E5EA);
    const double trackOpacity = 0.3;
    
    final bool isThresholdReached = progress >= 1.0;
    final Color activeColor = isThresholdReached ? AppConstants.ACCENT_COLOR : trackColor;
                ...
                children: [
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          ...
                          trackColor.withOpacity(_isTriggered ? trackOpacity : 0.0),
                        ],
                      ),
                  ...
                  AnimatedPositioned(
                    ...
                    child: AnimatedOpacity(
                      ...
                      opacity: _isTriggered ? 0.0 : 1.0, // Fade out dots on trigger
                      child: Column(
                        children: [
                          _buildDot(activeColor, trackOpacity, scale, opacityBoost),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Opacity(
                    ...
                    child: Text(
                      isThresholdReached ? "Release to view history" : "Pull to view history",
                      style: TextStyle(
                        color: isThresholdReached ? Colors.white : Colors.grey[600],
                        fontSize: 14,
                        fontWeight: isThresholdReached ? FontWeight.bold : FontWeight.normal,
                      ),
                    ),
                  ),
                ),
  ...
  Widget _buildDot(Color color, double opacity, double scale, double opacityBoost) {
    return Transform.scale(
      ...
      child: Container(
        ...
        height: 4,
        decoration: BoxDecoration(
          color: color.withOpacity((opacity + opacityBoost).clamp(0.0, 1.0)),
