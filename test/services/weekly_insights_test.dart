...
void main() {
  group('InsightsService - Weekly Insights Tests', () {
    ...
    test(
      'should calculate weekly insights correctly for default 6 months',
      () async {
    ...
    test('should use monthly grouping for longer timeframes (1 year)', () async {
      ...
      final lastMonthCounts =
          insights.weeklyWorkoutCounts[insights.weeklyWorkoutCounts.length - 2];
    ...
    test('should handle workouts with no completion time', () async {
      ...
      insightsService.setWorkoutsProvider(
        () async => [workoutWithNoCompletion],
      );
    ...
    group('WeeklyInsights Model Serialization', () {
      test('should convert to and from map correctly', () {
        ...
        expect(
          restored.averageWorkoutsPerWeek,
