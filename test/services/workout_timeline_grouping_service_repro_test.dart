...
void main() {
  group('WorkoutTimelineGroupingService Repro', () {
    test('should include workouts completed in the immediate future (due to rounding)', () {
      ...
      expect(result.recent.length, 1, reason: 'Future workout should be included in recent');
