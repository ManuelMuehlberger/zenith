...
void main() {
  testWidgets(
    'CreateWorkoutScreen - adding a set copies previous set values (direct model update)',
    (WidgetTester tester) async {
      ...
      final updatedRepsWidget = tester.widget<TextFormField>(
        updatedTextFields.at(0),
      );
      final updatedWeightWidget = tester.widget<TextFormField>(
        updatedTextFields.at(1),
      );
