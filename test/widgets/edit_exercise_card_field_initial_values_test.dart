...
void main() {
  ...
  testWidgets('renders targetReps for multiple sets without missing values', (
    tester,
  ) async {
    const exId = 'ex1';
  ...
  testWidgets('renders targetWeight for multiple sets without missing values', (
    tester,
  ) async {
    const exId = 'ex2';
    final sets = <WorkoutSet>[
  ...
  testWidgets(
    'unique field keys prevent TextFormField state reuse across exercises',
    (tester) async {
      final ex1 = exercise0(
        id: 'exA',
        templateId: 'tpl',
      ...
      final repsAController =
          (allTextFields[0].widget as TextFormField).controller;
      expect(repsAController!.text, '3');

      // Exercise 2, Set 2 Reps (index 6)
      final repsBController =
          (allTextFields[6].widget as TextFormField).controller;
  ...
  testWidgets('tapping reps field selects all text', (tester) async {
    ...
    final repsFieldFinder = find.byWidgetPredicate(
      (widget) => widget is TextFormField && widget.controller?.text == '12',
    );
  ...
  testWidgets('tapping weight field selects all text', (tester) async {
    ...
    final weightFieldFinder = find.byWidgetPredicate(
      (widget) => widget is TextFormField && widget.controller?.text == '30.5',
    );
  ...
  testWidgets(
    'weight field allows multi-digit numbers and up to two decimal places',
    (tester) async {
      const exId = 'ex1';
      final sets = [
        set(
  ...
  testWidgets(
    'typing weight from empty: 1 -> 10 -> 100 does not auto-format mid-typing',
    (tester) async {
      const exId = 'ex3';
      final sets = [
        set(
  ...
  testWidgets('select-all then delete weight keeps empty after blur', (
    tester,
  ) async {
    const exId = 'ex4';
    final sets = [
      set(id: 's1', workoutExerciseId: exId, setIndex: 0, reps: 8, weight: 1.0),
    ];
    final exercise = exercise0(
      id: exId,
      templateId: 'tpl',
