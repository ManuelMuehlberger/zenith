...
void main() {
  testWidgets(
    'ExpandableWorkoutCard shows exercise slug when exerciseDetail is null',
    (WidgetTester tester) async {
      ...
      final workoutExercise = WorkoutExercise(
        ...
        workoutId:
            workoutId, // satisfy assertion: exactly one of workoutId or workoutTemplateId must be set
  ...
  testWidgets(
    'ExpandableWorkoutCard (template) loads exercises via injected loader and shows slug/counts',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'ExpandableWorkoutCard (template) refreshes counts when template instance changes (same id)',
    (WidgetTester tester) async {
      // Arrange
      const templateId = 'template_update_1';
      final WorkoutTemplate templateV1 = WorkoutTemplate(
        id: templateId,
        name: 'Template V1',
  ...
  testWidgets(
    'ExpandableWorkoutCard switching from template to workout uses workout data (no stale template cache)',
    (WidgetTester tester) async {
