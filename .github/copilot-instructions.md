...
- Keep visual tokens in `lib/theme/`. Outside that directory, consume styling through `context.appScheme`, `context.appText`, and `context.appColors` from `lib/theme/app_theme.dart`.
